                    ...
                    <div className="col-lg-12">
                        <div className="row justify-content-center p-4">
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={bichara} alt="Candidate" className="img-fluid"/>
                                <p className="mt-2"><span></span>1 - BICHARA, AL FRANCIS (NP)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={rodel} alt="Candidate" className="img-fluid"/>
                                <p className="mt-2"><span></span>2 - LUNA, RODEL (IND)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={mar} alt="Candidate" className="img-fluid"/>
                                <p className="mt-2"><span></span>3 - MAR, BACUIL (IND)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={rosal} alt="Candidate" className="img-fluid colored"/>

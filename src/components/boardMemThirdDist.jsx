                    ...
                    <div className="col-lg-12">
                        <div className="row justify-content-center p-4">
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={dante} alt="Candidate Photo" className="img-fluid"/>
                                <p className="mt-2"><span></span>1 - ARANDIA, DANTE (PROMDI)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={herbert} alt="Candidate Photo" className="img-fluid"/>
                                <p className="mt-2"><span></span>2 - BORJA, HERBERT (NP)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={pem} alt="Candidate Photo" className="img-fluid"/>
                                <p className="mt-2"><span></span>3 - IMPERIAL, PEM (IND)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={lonzaga} alt="Candidate Photo" className="img-fluid"/>
                                <p className="mt-2"><span></span>4 - LONZAGA, DADDY GA (IND)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={jacem} alt="Candidate Photo" className="img-fluid"/>
                                <p className="mt-2"><span></span>5 - PALMIANO, JACEM (NUP)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={eva} alt="Candidate Photo" className="img-fluid"/>
                                <p className="mt-2"><span></span>6 - RIBAYA, EVA JOSEPHINE (NP)</p>
                            </div>
                            <div className="col-lg-2 col-sm-4 col-md-4 col-6 mt-4">
                                <img src={jesap} alt="Candidate Photo" className="img-fluid"/>
